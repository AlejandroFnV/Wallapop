		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 mb-5 ftco-animate">
					<a href="../frontassets/images/product-1.png" class="image-popup"><img src="data:image/jpeg;base64,{{ $producto->foto }}" class="img-fluid" alt="Colorlib Template"></a>
				</div>
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<div class="rating d-flex">
						...
						<p class="text-left mr-4">
							...
							<span style="color: #bbb;">Subido por <em>ti</em></span><br>
							@else
							<span style="color: #bbb;">Subido por <em>{{ $producto->usuario->name }}</em></span><br>
							@endif
							<span style="color: #bbb;">{{ $producto->categorias->categoria }}</span>
						</p>
						<!--<p class="text-left">-->
					...
					<div class="row mt-4">
						...
						<div class="w-100"></div>
						<div class="col-md-12">
							<p style="color: #000;">{{ $producto->estado }}</p>
						</div>
					</div>
					<p>
						@if($user->id == $producto->idusuario)
						<a href="{{ route('contacto.index', $producto->id) }}" class="btn btn-primary py-3 px-5 mr-2">Tienes mensajes nuevos</a>
						<a href="{{ url('producto/' . $producto->id . '/edit') }}" class="btn btn-primary py-3 px-5 mr-2">Editar</a>
						<a href="{{ route('producto.delete', $producto->id) }}" class="btn btn-black py-3 px-5 mr-2">Borrar</a>
						@else
						<a href="{{ route('contacto.index', $producto->id) }}" class="btn btn-black py-3 px-5 mr-2">Contacta</a>
						<form role="form" action="{{ url('deseo/' . $user->id . '/' . $producto->id) }}" method="post" id="createDeseoForm">
							<!--<a href="{{-- route('deseo.store') --}}" class="btn btn-primary py-3 px-5">Añadir a mis deseos</a>-->
							@csrf
