...
<body class="goto-here">
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    ...
                    <h1 class="mb-0 bread">Edita tu producto</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row block-9">
        <div class="col-md-12 order-md-last d-flex">
            <form action="{{ url('producto/' . $producto->id) }}" method="post" enctype="multipart/form-data" class="bg-white p-5 contact-form">
                @csrf
                @method('put')
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre del producto" value="{{ old('nombre' , $producto->nombre) }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="idcategoria" id="idcategoria" required class="form-control">
                        <option value="" disabled selected>{{ $producto->categorias->categoria }}</option>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="uso" name="uso" placeholder="Uso" value="{{ old('uso' , $producto->uso) }}">
                </div>
                ...
                <div class="form-group">
                    <textarea cols="30" rows="7" class="form-control" id="descripcion" name="descripcion" placeholder="Descripción">{{ old('descripcion' , $producto->descripcion) }}</textarea>
                </div>
                ...
                <!--<div class="form-group">-->
                <!--    <input type="text" class="form-control" id="estado" name="estado" placeholder="Estado" value="{{ old('estado' , $producto->estado) }}">-->
                <!--</div>-->
