            ...
            <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <div class="text">
                ...
                <div class="horizontal">
                  ...
                  <p><a href="{{ route('login') }}" class="btn-custom">Logueate para ver todos nuestros productos</a></p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <div class="text">
                ...
                <div class="horizontal">
                  ...
                  <p class="mb-4">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country.</p>
                  <p><a href="{{ route('register') }}" class="btn-custom">O regístrate si no tienes cuenta</a></p>
                </div>
              </div>
            </div>
          </div>
