...
<head>
  ...
  <title>Wallapop Backend | Dashboard</title>
  @yield('prestyle')
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form action="{{-- route('backend.enterprise.paginate.index') --}}" class="form-inline ml-3">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item has-treeview {{ $openTicket ?? '' }}">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('backend.producto.index') }}" class="nav-link"> {{-- if(isset($viewOpenTicket)) $viewOpenTicket else '' --}}
                      <i class="far fa-circle nav-icon"></i>
                      <p>Ver productos</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('backend.producto.create') }}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Añadir producto</p>
                    </a>
                  </li>
             ...
             <li class="nav-item has-treeview {{ $openTicket ?? '' }}">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('backend.categoria.index') }}" class="nav-link"> {{-- if(isset($viewOpenTicket)) $viewOpenTicket else '' --}}
                      <i class="far fa-circle nav-icon"></i>
                      <p>Listado de categorías</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('backend.categoria.create') }}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
             ...
             <li class="nav-item has-treeview {{ $openTicket ?? '' }}">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('backend.deseo.index') }}" class="nav-link"> {{-- if(isset($viewOpenTicket)) $viewOpenTicket else '' --}}
                      <i class="far fa-circle nav-icon"></i>
                      <p>Listado de deseos</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('backend.deseo.create') }}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Añadir deseo</p>
                    </a>
                  </li>
