      ...
      <div class="slider-item js-fullheight">
        ...
        <div class="container-fluid p-0">
          <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
            <img class="one-third order-md-last img-fluid" src="frontassets/images/bg_1.png" alt="">
      ...
      <div class="slider-item js-fullheight">
        ...
        <div class="container-fluid p-0">
          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
            <img class="one-third order-md-last img-fluid" src="frontassets/images/bg_2.png" alt="">
            <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <div class="text">
                <span class="subheading">#New Arrival</span>
                <div class="horizontal">
    ...
    <div class="container">
      <div class="row justify-content-center mb-3 pb-3">
        <div class="col-md-12 heading-section text-center ftco-animate">
          ...
          <p>Echa un vistazo a nuestros productos más frescos</p>
        </div>
      </div>
    </div>
    <div class="container">
          ...
          <div class="product d-flex flex-column">
            ...
            <div class="text py-3 pb-4 px-3">
              ...
              <p class="bottom-area d-flex px-3">
                ...
                <a href="{{ route('contacto.index', $producto->id) }}" class="buy-now text-center py-2">Chat<span><i class="ion-ios-chatboxes"></i></span></a>
              </p>
...
<!--        <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">-->
<!--          <div class="product d-flex flex-column">-->
<!--            <a href="#" class="img-prod"><img class="img-fluid" src="frontassets/images/product-2.png" alt="Colorlib Template">-->
...
<!--        <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">-->
<!--          <div class="product">-->
<!--            <a href="#" class="img-prod"><img class="img-fluid" src="frontassets/images/product-3.png" alt="Colorlib Template">-->
<!--<div class="overlay"></div>-->
<!--</a>-->
<!--            <div class="text py-3 pb-4 px-3">-->
<!--              <div class="d-flex">-->
...
<!--        <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">-->
<!--          <div class="product">-->
<!--            <a href="#" class="img-prod"><img class="img-fluid" src="frontassets/images/product-4.png" alt="Colorlib Template">-->
<!--<div class="overlay"></div>-->
<!--</a>-->
<!--            <div class="text py-3 pb-4 px-3">-->
<!--              <div class="d-flex">-->
...
<!--        <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">-->
<!--          <div class="product d-flex flex-column">-->
<!--            <a href="#" class="img-prod"><img class="img-fluid" src="frontassets/images/product-5.png" alt="Colorlib Template">-->
<!--<div class="overlay"></div>-->
<!--</a>-->
<!--            <div class="text py-3 pb-4 px-3">-->
<!--              <div class="d-flex">-->
...
<!--        <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">-->
<!--          <div class="product d-flex flex-column">-->
<!--            <a href="#" class="img-prod"><img class="img-fluid" src="frontassets/images/product-6.png" alt="Colorlib Template">-->
<!--<span class="status">50% Off</span>-->
<!--<div class="overlay"></div>-->
<!--</a>-->
<!--            <div class="text py-3 pb-4 px-3">-->
...
<!--        <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">-->
<!--          <div class="product">-->
<!--            <a href="#" class="img-prod"><img class="img-fluid" src="frontassets/images/product-7.png" alt="Colorlib Template">-->
<!--<div class="overlay"></div>-->
<!--</a>-->
<!--            <div class="text py-3 pb-4 px-3">-->
<!--              <div class="d-flex">-->
...
<!--        <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">-->
<!--          <div class="product">-->
<!--            <a href="#" class="img-prod"><img class="img-fluid" src="frontassets/images/product-8.png" alt="Colorlib Template">-->
<!--<div class="overlay"></div>-->
<!--</a>-->
<!--            <div class="text py-3 pb-4 px-3">-->
<!--              <div class="d-flex">-->
...
<!--        </div>-->
  ...
  <section class="ftco-section ftco-choose ftco-no-pb ftco-no-pt">
    <div class="container">
      <div class="row no-gutters">
        <div class="col-lg-4">
          <div class="choose-wrap divider-one img p-5 d-flex align-items-end" style="background-image: url(frontassets/images/choose-1.jpg);">
        ...
        <div class="col-lg-8">
          <div class="row no-gutters choose-wrap divider-two align-items-stretch">
            <div class="col-md-12">
              <div class="choose-wrap full-wrap img align-self-stretch d-flex align-item-center justify-content-end" style="background-image: url(frontassets/images/choose-2.jpg);">
            ...
            <div class="col-md-12">
              <div class="row no-gutters">
                ...
                <div class="col-md-6">
                  <div class="choose-wrap wrap img align-self-stretch d-flex align-items-center" style="background-image: url(frontassets/images/choose-3.jpg);">
  ...
  <section class="ftco-section ftco-deal bg-primary">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <img src="frontassets/images/prod-1.png" class="img-fluid" alt="">
        </div>
        <div class="col-md-6">
          ...
          <div class="text-deal">
            ...
            <ul class="thumb-deal d-flex mt-4">
              <li class="img" style="background-image: url(frontassets/images/product-6.png);"></li>
              <li class="img" style="background-image: url(frontassets/images/product-2.png);"></li>
              <li class="img" style="background-image: url(frontassets/images/product-4.png);"></li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="carousel-testimony owl-carousel">
            <div class="item">
              <div class="testimony-wrap">
                <div class="user-img mb-4" style="background-image: url(frontassets/images/person_1.jpg)">
...
<i class="icon-quote-left"></i>
            ...
            <div class="item">
              <div class="testimony-wrap">
                <div class="user-img mb-4" style="background-image: url(frontassets/images/person_2.jpg)">
                  <span class="quote d-flex align-items-center justify-content-center">
<i class="icon-quote-left"></i>
</span>
                </div>
            ...
            <div class="item">
              <div class="testimony-wrap">
                <div class="user-img mb-4" style="background-image: url(frontassets/images/person_3.jpg)">
                  <span class="quote d-flex align-items-center justify-content-center">
<i class="icon-quote-left"></i>
</span>
                </div>
    ...
    <div class="container-fluid px-0">
      <div class="row no-gutters">
        <div class="col-md-4 col-lg-2 ftco-animate">
          <a href="images/gallery-1.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(frontassets/images/gallery-1.jpg);">
        ...
        <div class="col-md-4 col-lg-2 ftco-animate">
          <a href="images/gallery-2.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(frontassets/images/gallery-2.jpg);">
            <div class="icon mb-4 d-flex align-items-center justify-content-center">
              <span class="icon-instagram"></span>
            </div>
          </a>
        ...
        <div class="col-md-4 col-lg-2 ftco-animate">
          <a href="images/gallery-3.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(frontassets/images/gallery-3.jpg);">
            <div class="icon mb-4 d-flex align-items-center justify-content-center">
              <span class="icon-instagram"></span>
            </div>
          </a>
        ...
        <div class="col-md-4 col-lg-2 ftco-animate">
          <a href="images/gallery-4.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(frontassets/images/gallery-4.jpg);">
            <div class="icon mb-4 d-flex align-items-center justify-content-center">
              <span class="icon-instagram"></span>
            </div>
          </a>
        ...
        <div class="col-md-4 col-lg-2 ftco-animate">
          <a href="images/gallery-5.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(frontassets/images/gallery-5.jpg);">
            <div class="icon mb-4 d-flex align-items-center justify-content-center">
              <span class="icon-instagram"></span>
            </div>
          </a>
        ...
        <div class="col-md-4 col-lg-2 ftco-animate">
          <a href="images/gallery-6.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(frontassets/images/gallery-6.jpg);">
            <div class="icon mb-4 d-flex align-items-center justify-content-center">
              <span class="icon-instagram"></span>
            </div>
          </a>
